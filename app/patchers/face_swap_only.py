...
def apply(workflow: dict, params: dict) -> dict:
    ...
    s["detect_gender_input"] = params.get("detect_gender_input", s.get("detect_gender_input", "no"))
    s["detect_gender_source"] = params.get("detect_gender_source", s.get("detect_gender_source", "no"))
